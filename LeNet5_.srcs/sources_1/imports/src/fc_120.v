...
//        F6_STORE_2nd: begin
//            F6Out[BIT_WIDTH*3-1:BIT_WIDTH*2] <= F6_relu[0];
//            F6Out[BIT_WIDTH*4-1:BIT_WIDTH*3] <= F6_relu[1];
//        end
//        F6_STORE_3rd: begin
//            F6Out[BIT_WIDTH*5-1:BIT_WIDTH*4] <= F6_relu[0];
//            F6Out[BIT_WIDTH*6-1:BIT_WIDTH*5] <= F6_relu[1];
//        end
//        F6_STORE_4th: begin
//            F6Out[BIT_WIDTH*7-1:BIT_WIDTH*6] <= F6_relu[0];
//            F6Out[BIT_WIDTH*8-1:BIT_WIDTH*7] <= F6_relu[1];
//        end
//        F6_STORE_5th: begin
//            F6Out[BIT_WIDTH*9-1:BIT_WIDTH*8] <= F6_relu[0];
//            F6Out[BIT_WIDTH*10-1:BIT_WIDTH*9] <= F6_relu[1];
//        end
//        F6_STORE_6th: begin
//            F6Out[BIT_WIDTH*11-1:BIT_WIDTH*10] <= F6_relu[0];
//            F6Out[BIT_WIDTH*12-1:BIT_WIDTH*11] <= F6_relu[1];
//        end
//        F6_STORE_7th: begin
//            F6Out[BIT_WIDTH*13-1:BIT_WIDTH*12] <= F6_relu[0];
//            F6Out[BIT_WIDTH*14-1:BIT_WIDTH*13] <= F6_relu[1];
//        end
//        F6_STORE_8th: begin
//            F6Out[BIT_WIDTH*15-1:BIT_WIDTH*14] <= F6_relu[0];
//            F6Out[BIT_WIDTH*16-1:BIT_WIDTH*15] <= F6_relu[1];
//        end
//        F6_STORE_9th: begin
//            F6Out[BIT_WIDTH*17-1:BIT_WIDTH*16] <= F6_relu[0];
//            F6Out[BIT_WIDTH*18-1:BIT_WIDTH*17] <= F6_relu[1];
//        end
//        F6_STORE_10th: begin
//            F6Out[BIT_WIDTH*19-1:BIT_WIDTH*18] <= F6_relu[0];
//            F6Out[BIT_WIDTH*20-1:BIT_WIDTH*19] <= F6_relu[1];
//        end
//        F6_STORE_11th: begin
//            F6Out[BIT_WIDTH*21-1:BIT_WIDTH*20] <= F6_relu[0];
//            F6Out[BIT_WIDTH*22-1:BIT_WIDTH*21] <= F6_relu[1];
//        end
//        F6_STORE_12th: begin
//            F6Out[BIT_WIDTH*23-1:BIT_WIDTH*22] <= F6_relu[0];
//            F6Out[BIT_WIDTH*24-1:BIT_WIDTH*23] <= F6_relu[1];
//        end
//        F6_STORE_13th: begin
//            F6Out[BIT_WIDTH*25-1:BIT_WIDTH*24] <= F6_relu[0];
//            F6Out[BIT_WIDTH*26-1:BIT_WIDTH*25] <= F6_relu[1];
//        end
//        F6_STORE_14th: begin
//            F6Out[BIT_WIDTH*27-1:BIT_WIDTH*26] <= F6_relu[0];
//            F6Out[BIT_WIDTH*28-1:BIT_WIDTH*27] <= F6_relu[1];
//        end
//        F6_STORE_15th: begin
//            F6Out[BIT_WIDTH*29-1:BIT_WIDTH*28] <= F6_relu[0];
//            F6Out[BIT_WIDTH*30-1:BIT_WIDTH*29] <= F6_relu[1];
//        end
//        F6_STORE_16th: begin
//            F6Out[BIT_WIDTH*31-1:BIT_WIDTH*30] <= F6_relu[0];
//            F6Out[BIT_WIDTH*32-1:BIT_WIDTH*31] <= F6_relu[1];
//        end
//        F6_STORE_17th: begin
//            F6Out[BIT_WIDTH*33-1:BIT_WIDTH*32] <= F6_relu[0];
//            F6Out[BIT_WIDTH*34-1:BIT_WIDTH*33] <= F6_relu[1];
//        end
//        F6_STORE_18th: begin
//            F6Out[BIT_WIDTH*35-1:BIT_WIDTH*34] <= F6_relu[0];
//            F6Out[BIT_WIDTH*36-1:BIT_WIDTH*35] <= F6_relu[1];
//        end
//        F6_STORE_19th: begin
//            F6Out[BIT_WIDTH*37-1:BIT_WIDTH*36] <= F6_relu[0];
//            F6Out[BIT_WIDTH*38-1:BIT_WIDTH*37] <= F6_relu[1];
//        end
//        F6_STORE_20th: begin
//            F6Out[BIT_WIDTH*39-1:BIT_WIDTH*38] <= F6_relu[0];
//            F6Out[BIT_WIDTH*40-1:BIT_WIDTH*39] <= F6_relu[1];
//        end
//        F6_STORE_21st: begin
//            F6Out[BIT_WIDTH*41-1:BIT_WIDTH*40] <= F6_relu[0];
//            F6Out[BIT_WIDTH*42-1:BIT_WIDTH*41] <= F6_relu[1];
//        end
//        F6_STORE_22nd: begin
//            F6Out[BIT_WIDTH*43-1:BIT_WIDTH*42] <= F6_relu[0];
//            F6Out[BIT_WIDTH*44-1:BIT_WIDTH*43] <= F6_relu[1];
//        end
//        F6_STORE_23rd: begin
//            F6Out[BIT_WIDTH*45-1:BIT_WIDTH*44] <= F6_relu[0];
//            F6Out[BIT_WIDTH*46-1:BIT_WIDTH*45] <= F6_relu[1];
//        end
//        F6_STORE_24th: begin
//            F6Out[BIT_WIDTH*47-1:BIT_WIDTH*46] <= F6_relu[0];
//            F6Out[BIT_WIDTH*48-1:BIT_WIDTH*47] <= F6_relu[1];
//        end
//        F6_STORE_25th: begin
//            F6Out[BIT_WIDTH*49-1:BIT_WIDTH*48] <= F6_relu[0];
//            F6Out[BIT_WIDTH*50-1:BIT_WIDTH*49] <= F6_relu[1];
//        end
//        F6_STORE_26th: begin
//            F6Out[BIT_WIDTH*51-1:BIT_WIDTH*50] <= F6_relu[0];
//            F6Out[BIT_WIDTH*52-1:BIT_WIDTH*51] <= F6_relu[1];
//        end
//        F6_STORE_27th: begin
//            F6Out[BIT_WIDTH*53-1:BIT_WIDTH*52] <= F6_relu[0];
//            F6Out[BIT_WIDTH*54-1:BIT_WIDTH*53] <= F6_relu[1];
//        end
//        F6_STORE_28th: begin
//            F6Out[BIT_WIDTH*55-1:BIT_WIDTH*54] <= F6_relu[0];
//            F6Out[BIT_WIDTH*56-1:BIT_WIDTH*55] <= F6_relu[1];
//        end
//        F6_STORE_29th: begin
//            F6Out[BIT_WIDTH*57-1:BIT_WIDTH*56] <= F6_relu[0];
//            F6Out[BIT_WIDTH*58-1:BIT_WIDTH*57] <= F6_relu[1];
//        end
//        F6_STORE_30th: begin
//            F6Out[BIT_WIDTH*59-1:BIT_WIDTH*58] <= F6_relu[0];
//            F6Out[BIT_WIDTH*60-1:BIT_WIDTH*59] <= F6_relu[1];
//        end
//        F6_STORE_31st: begin
//            F6Out[BIT_WIDTH*61-1:BIT_WIDTH*60] <= F6_relu[0];
//            F6Out[BIT_WIDTH*62-1:BIT_WIDTH*61] <= F6_relu[1];
//        end
//        F6_STORE_32nd: begin
//            F6Out[BIT_WIDTH*63-1:BIT_WIDTH*62] <= F6_relu[0];
//            F6Out[BIT_WIDTH*64-1:BIT_WIDTH*63] <= F6_relu[1];
//        end
//        F6_STORE_33rd: begin
//            F6Out[BIT_WIDTH*65-1:BIT_WIDTH*64] <= F6_relu[0];
//            F6Out[BIT_WIDTH*66-1:BIT_WIDTH*65] <= F6_relu[1];
//        end
//        F6_STORE_34th: begin
//            F6Out[BIT_WIDTH*67-1:BIT_WIDTH*66] <= F6_relu[0];
//            F6Out[BIT_WIDTH*68-1:BIT_WIDTH*67] <= F6_relu[1];
//        end
//        F6_STORE_35th: begin
//            F6Out[BIT_WIDTH*69-1:BIT_WIDTH*68] <= F6_relu[0];
//            F6Out[BIT_WIDTH*70-1:BIT_WIDTH*69] <= F6_relu[1];
//        end
//        F6_STORE_36th: begin
//            F6Out[BIT_WIDTH*71-1:BIT_WIDTH*70] <= F6_relu[0];
//            F6Out[BIT_WIDTH*72-1:BIT_WIDTH*71] <= F6_relu[1];
//        end
//        F6_STORE_37th: begin
//            F6Out[BIT_WIDTH*73-1:BIT_WIDTH*72] <= F6_relu[0];
//            F6Out[BIT_WIDTH*74-1:BIT_WIDTH*73] <= F6_relu[1];
//        end
//        F6_STORE_38th: begin
//            F6Out[BIT_WIDTH*75-1:BIT_WIDTH*74] <= F6_relu[0];
//            F6Out[BIT_WIDTH*76-1:BIT_WIDTH*75] <= F6_relu[1];
//        end
//        F6_STORE_39th: begin
//            F6Out[BIT_WIDTH*77-1:BIT_WIDTH*76] <= F6_relu[0];
//            F6Out[BIT_WIDTH*78-1:BIT_WIDTH*77] <= F6_relu[1];
//        end
//        F6_STORE_40th: begin
//            F6Out[BIT_WIDTH*79-1:BIT_WIDTH*78] <= F6_relu[0];
//            F6Out[BIT_WIDTH*80-1:BIT_WIDTH*79] <= F6_relu[1];
//        end
//        F6_STORE_41st: begin
//            F6Out[BIT_WIDTH*81-1:BIT_WIDTH*80] <= F6_relu[0];
//            F6Out[BIT_WIDTH*82-1:BIT_WIDTH*81] <= F6_relu[1];
//        end
//        F6_STORE_42nd: begin
//            F6Out[BIT_WIDTH*83-1:BIT_WIDTH*82] <= F6_relu[0];
//            F6Out[BIT_WIDTH*84-1:BIT_WIDTH*83] <= F6_relu[1];
//        end 
//    endcase
end
